...
function renderNotes(){
    ...
    sortedDates.forEach(d => {
        ...
        div.className = "bg-gray-800 border-gray-700 rounded-lg p-3 flex justify-between items-start";
        ...
        editBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pen" viewBox="0 0 16 16">
        ...
        //del btn
        const delBtn = document.createElement("button");
        delBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
        ...
        saveBtn.innerHTML=`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
        <path d="M10.97 4.97a.75.75 0 0 1 1.07 1.05l-3.99 4.99a.75.75 0 0 1-1.08.02L4.324 8.384a.5.5 0 1 1 1.06-1.06l2.094 2.093 3.473-4.425z"/>
        </svg>`;
        saveBtn.className ="p-1 rounded hover:bg-gray-700 transition text-green-400 hover:text-green-300";
        saveBtn.addEventListener("click", () => {
            state.notes[noteDate.value] = noteText.value;
            saveState();
            renderNotes();
        })
